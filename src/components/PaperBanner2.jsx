    ...
    return (
			<div className="banner2 h-[30vh] relative w-full shadow-xl flex flex-col items-start bg-repeat bg-[url(./paper-bg.jpg)] justify-center">
				...
				<div className="w-full absolute h-full flex flex-col items-center justify-center">
					<p className="w-full text-center text-[#46296e] sedan-regular">{details?.reach_out?.sub_title}</p>
					<div className="w-4/5 px-4  flex justify-center gap-2  items-center">
						<div className="h-[2px] w-[10%] md:w-[6%] bg-black "></div>
						<p className="h-full sedan-regular flex px-2 items-center justify-center   text-center text-3xl md:text-4xl ">{details?.reach_out?.title}</p>
						<div className="h-[2px] w-[10%] md:w-[6%] bg-black"></div>
					</div>
					<p className="w-full text-center font-thin  mt-4 text-xl">{details?.reach_out?.description}</p>
				</div>
			</div>
		);
  }
