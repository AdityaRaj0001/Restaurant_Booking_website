  ...
  return (
    <div className="w-full h-[70vh] md:h-[100vh]  md:gap-4 py-16 flex flex-col items-center justify-center">
      <div className="w-full h-[50%] flex justify-between  mb-4">
        ...
        <div className="w-[48%] md:w-[24%] overflow-hidden   object-cover">
          <img src="./about-image-5.jpg" className="md:w-full max-w-none transform transition-transform duration-500 hover:scale-110 h-full" />
        </div>
      
        <div className="w-[48%] md:w-[24%] hidden overflow-hidden md:block object-cover">
        <img src="./about-image-2.jpg" className="md:w-full max-w-none transform transition-transform duration-500 hover:scale-110 h-full" />
        </div>
        <div className="w-[48%] md:w-[24%] hidden overflow-hidden md:block object-cover">
        <img src="./about-image-3.jpg" className="md:w-full max-w-none transform transition-transform duration-500 hover:scale-110 h-full" />
        </div>
      </div>
      <div className="w-full h-[50%] flex justify-between  mb-4">
        <div className="w-[48%] md:w-[24%] overflow-hidden   object-cover">
