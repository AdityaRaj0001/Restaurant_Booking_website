...
const Hero = ({ maintext, heroimg }) => {
  ...
  return (
    <div className="h-[60vh] overflow-hidden  relative w-full  flex-col text-white  flex items-center justify-center">
      <img
        src={heroimg}
      ...
      <div className="h-1/2 mb-4   w-full  flex flex-col items-center justify-center text">
        <div className="h-1/5 w-full flex justify-center gap-4 items-center">
          ...
          <p className="w-auto h-full flex items-center justify-center font-thin  text-center text-3xl font-medium ">
            {maintext}
          </p>
          <div className="h-[2px] w-[5%] bg-white"></div>
        </div>
