...
<<<<<<< HEAD
  ...
  const heroImageSrc = heroUrl ? heroUrl : "./homehero.jpg";
  return (
		<div className="h-[70vh] md:h-[100vh] relative w-full  flex-col text-white  flex items-center justify-center">
			<img src={heroImageSrc} className="h-full md:w-full md:h-full  -z-20 absolute object-cover object-top" alt="hero-img" />
			...
			<div className="h-1/2 mb-4   w-full  flex flex-col items-center justify-center text">
				...
				<div className="h-1/5 w-full flex justify-center gap-4 items-center">
					...
					<p className="w-auto h-full flex items-center justify-center font-thin  text-center text-3xl ">MODERN INDIAN CUISINE</p>
					<div className="h-[2px] w-[5%] bg-white"></div>
				</div>
				...
				<span className=" w-1/2 md:mt-12 md:text-lg  opacit-30 text-center text-sm">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aspernatur, itaque!</span>
